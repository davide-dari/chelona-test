...
await clickText('Volantini'); await new Promise(r => setTimeout(r, 3500));
console.log((await page.evaluate(() => document.body.innerText)).slice(0, 900));
console.log('--- INPUTS ---', JSON.stringify(await page.evaluate(() => [...document.querySelectorAll('input')].map(i => i.placeholder))));
await page.screenshot({ path: '/tmp/vol.png' });
await browser.close();

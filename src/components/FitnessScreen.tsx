...
const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  { name: 'Chest Press', muscleGroup: 'chest', equipment: ['gym'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/1301-38WpP6C.gif', compound: true },
  { name: 'Push-up', muscleGroup: 'chest', equipment: ['gym', 'home', 'bodyweight'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/0662-Vn12Tsm.gif', compound: true },
  { name: 'Push-up Diamante', muscleGroup: 'chest', equipment: ['gym', 'home', 'bodyweight'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/0283-xR8yZ2M.gif', compound: true },
  { name: 'Dip alle Parallele', muscleGroup: 'chest', equipment: ['gym', 'home'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/0251-Z7bBw7s.gif', compound: true },
  ...
  { name: 'Pectoral Machine', muscleGroup: 'chest', equipment: ['gym'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/0335-W02kX1m.gif', compound: false },
  // Back
  ...
  { name: 'Lat Machine', muscleGroup: 'back', equipment: ['gym'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/2330-yK8GZ01.gif', compound: true },
  ...
  { name: 'Face Pull', muscleGroup: 'shoulders', equipment: ['gym'], gifUrl: 'https://raw.githubusercontent.com/hasaneyldrm/exercises-dataset/main/videos/0182-vH6X5Gz.gif', compound: false },

    ...
    return (
      <div className="flex flex-col h-full rounded-2xl glass-panel overflow-hidden relative items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-2">Connetti Gemini API</h2>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider">Poi incollala qui</span>
            <div className="flex-1 h-px bg-gray-700"></div>
          </div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto space-y-6 custom-scrollbar pr-2">
                ...
                <div className="pt-4 border-t border-gray-800">
                  <h3 className="text-sm font-medium text-gray-300 mb-3">Gestione Chiave API</h3>
                  <button 
                    onClick={removeKey}
                  ...
                  >
                    <Key size={16} /> Rimuovi Chiave Google API
                  </button>
                </div>
              </div>
